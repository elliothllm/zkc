...
type CdkErigonApi interface {
	...
	GetLatestGlobalExitRoot() (string, error)
	GetProverInput(batchNumber uint64, mode *WitnessMode, debug bool) (*ProverInput, error)
	GetRollupAddress() (string, error)
	GetRollupManagerAddress() (string, error)
	GetVersionHistory() (VersionHistory, error)
	GetWitness(blockNumber RpcBlockOrBatchNumber, mode *WitnessMode, debug bool) (string, error)
	IsBlockConsolidated(blockNumber RpcBlockOrBatchNumber) (bool, error)
	IsBlockVirtualized(blockNumber RpcBlockOrBatchNumber) (bool, error)
	VerifiedBatchNumber() (string, error)
	VirtualBatchNumber() (string, error)
}
